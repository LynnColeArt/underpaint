...
set(dp_proto_regex "^[ \t]*version:[ \t]*\"?(dp|underpaint):([0-9]+)\\.([0-9]+)\\.([0-9]+)\"?$")
...
if(dp_proto_version MATCHES ${dp_proto_regex})
	set(DRAWPILE_PROTO_SERVER_VERSION ${CMAKE_MATCH_2})
	set(DRAWPILE_PROTO_MAJOR_VERSION ${CMAKE_MATCH_3})
	set(DRAWPILE_PROTO_MINOR_VERSION ${CMAKE_MATCH_4})
else()
